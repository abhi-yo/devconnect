        ...
        >
          <AnimatePresence mode="popLayout">
            {hoveredIndex === item.id && (
              ...
              >
                <div className="absolute inset-x-10 -bottom-px z-30 h-px w-[20%] bg-gradient-to-r from-transparent via-rose-500 to-transparent" />
          ...
          <Image
            ...
            src={item.image}
            alt={item.name}
            className="relative !m-0 h-14 w-14 rounded-full border-2 border-white object-cover object-top !p-0 transition duration-500 group-hover:z-30 group-hover:scale-105 group-hover:border-rose-500"
          />
        </div>
      ))}
    </>

...
export const LampContainer = ({
  ...
  return (
    <div
      className={cn(
        // Modified: Removed min-h-screen, changed bg to zinc-950
        "relative flex flex-col items-center justify-center overflow-hidden bg-zinc-950 w-full pt-8 md:pt-16 z-0",
        className
      )}
    >
      <div className="relative flex w-full flex-1 scale-y-125 items-center justify-center isolate z-0 ">
        <motion.div
          ...
          style={{
            // Updated gradient color to match theme (rose)
        ...
        {/* Updated blur/overlay colors */}
        <div className="absolute top-1/2 h-48 w-full translate-y-12 scale-x-150 bg-zinc-950 blur-2xl"></div>
        <div className="absolute top-1/2 z-50 h-48 w-full bg-transparent opacity-10 backdrop-blur-md"></div>
        <div className="absolute inset-auto z-50 h-36 w-[30rem] -translate-y-1/2 rounded-full bg-rose-500 opacity-65 blur-3xl"></div>
        <motion.div
          initial={{ width: "8rem" }}
